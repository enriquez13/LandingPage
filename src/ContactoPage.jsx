export const Contacto = () => {
    return (
        <div id="contacto" className='pb-5  md:px-20 pt-10 justify-center ' >
            <h2 className='md:text-2xl mb-5 text-center text-[#192E40]'>Contactos</h2>

            <section  className="mx-5 md:mx-96 border border-[#192E40] rounded-lg">
                <div  className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                    <form action="#"  className="space-y-8">
                        <div>
                            <label for="nombre"  className="block mb-2 text-sm font-medium text-[#192E40]">Nombre</label>
                        ...
                        <div>
                            <label for="email"  className="block mb-2 text-sm font-medium text-[#192E40]">Email</label>
                        ...
                        <div>
                            <label for="subject"  className="block mb-2 text-sm font-medium text-[#192E40]">Teléfono</label>
                        ...
                        <div  className="sm:col-span-2">
                            <label for="message"  className="block mb-2 text-sm font-medium text-[#192E40]">Mensage</label>
