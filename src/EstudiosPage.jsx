...
<div className="justify-self-center mb-5 md:mx-5 mt-2 w-2/3  bg-white rounded-lg border border-gray-200 
shadow-md dark:bg-gray-800 dark:border-gray-700">
    
    <a  href="#">
        <img  className="md:mx-auto md:block w-full max-w-[220px] rounded-t-lg " src={imagen} alt={imagen}/>
    </a>
